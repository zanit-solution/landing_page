        ...
        <div>
            ...
            <div className='grid sm:grid-cols-1 md:grid-cols-2 lg-grid-cols-3 gap-5'>
                <div className='border p-4  rounded-lg bg-slate-100'>
                    ...
                    <div className='grid justify-center m-4'><button className='flex justify-center gap-5'><p className='text-center text-xl  font-bold'>Read more</p> <span><VscArrowSmallRight className='w-10 h-10' /></span> </button></div>
                </div>
                <div className='border p-4 rounded-lg bg-slate-100'>
