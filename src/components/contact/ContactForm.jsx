...
const ContactForm = () => {
    ...
    return (
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 py-20 items-center bg-slate-100">
            <div>
                <h1 className='text-9xl text-red-600 font-extrabold text-center'>Get in <br /> Touch</h1>
                <p className='text-lg font-bold text-center'>We will be happy to assist you !</p>
            </div>
